...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_effects.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_lahaina/audio_effects.conf \
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/perf/thermal_info_config.json:$(TARGET_COPY_OUT_VENDOR)/etc/thermal_info_config.json
